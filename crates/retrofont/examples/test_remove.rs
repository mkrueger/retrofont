...
fn main() {
    ...
    println!(
        "Before remove: has_char('A')={}, has_char('B')={}, count={}",
        font.has_char('A'),
        font.has_char('B'),
        font.glyph_count()
    );
    ...
    println!(
        "After remove_glyph('A'): removed={}, has_char('A')={}, has_char('B')={}, count={}",
        removed,
        font.has_char('A'),
        font.has_char('B'),
        font.glyph_count()
    ...
    println!(
        "After remove_glyph('B'): removed={}, has_char('B')={}, count={}",
        removed2,
        parsed.has_char('B'),
        parsed.glyph_count()
    );
